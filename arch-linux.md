...
2.1\. [Installation Image and Live Environment](#21-installation-image-and-live-environment)  
2.1.1\. [Acquire and Prepare Installation](#211-acquire-and-prepare-installation)  
2.1.2\. [Boot to Arch Linux Live Environment](#212-boot-to-arch-linux-environment)  
2.2\. [Console Keyboard Layout and Font](#22-console-keyboard-layout-and-font)  
2.2.1\. [Console Keyboard Layout](#221-console-keyboard-layout)  
2.2.2\. [Console Font](#222-console-font)  
2.3\. [Verify Boot Mode](#23-verify-boot-mode)  
2.4\. [Connect to the Internet](#24-connect-to-the-internet)  
2.4.1\. [Network Interfaces](#241-network-interfaces)  
2.4.2\. [Network Devices](#242-network-devices)  
2.4.3\. [Connect to a Network](#243-connect-to-a-network)  
2.4.4\. [Managing Networks](#244-managing-networks)  
2.5\. [System Clock](#25-system-clock)  
2.6\. [Disk Partitioning](#26-disk-partitioning)  
2.6.1\. [Partition Disks](#261-partition-disks)  
2.6.2\. [Format Partitions](#262-format-partitions)  
2.6.3\. [Mount Partitions](#263-mount-partitions)  
3\. [Installation](#3-installation)  
3.1\. [Mirrors](#31-mirrors)  
3.2\. [Essential Packages](#32-essential-packages)  
4\. [Configuration](#4-configuration)  
4.1\. [Fstab](#41-fstab)  
4.2\. [Change Root into New System](#42-change-root-into-new-system)  
4.3\. [Set Time Zone](#43-set-time-zone)  
4.3.1\. [Network Time Protocol](#431-network-time-protocol)  
4.4\. [Localization](#44-localization)  
4.5\. [Network Configuration](#45-network-configuration)  
4.6\. [Root Password](#46-root-password)  
4.7\. [Install Bootloader](#47-install-bootloader)  
4.8\. [Reboot](#48-reboot)  
5\. [Post-Installation](#5-post-installation)  
5.1\. [System Administration](#51-system-administration)  
5.1.1\. [Users and Groups](#511-users-and-groups)  
5.1.1.1\. [Superuser](#5111-superuser)  
5.1.1.2\. [Users](#5112-users)  
5.1.1.3\. [Groups](#5113-groups)  
5.1.1.4\. [Privilege Elevation](#5114-privilege-elevation)  
5.1.2\. [Permissions](#512-permissions)  
5.1.2.1\. [Symbolic Representation](#5121-symbolic-representation)  
5.1.2.2\. [Numeric Representation](#5122-numeric-representation)  
5.1.2.3\. [Default Permissions](#5123-default-permissions)  
5.1.3\. [Service Management](#513-service-management)  
5.1.4\. [System Maintenance](#514-system-maintenance)  
5.1.4.1\. [Check For Errors](#5141-check-for-errors)  
5.1.4.2\. [Backup](#5142-backup)  
5.2\. [Package Management](#52-package-management)  
5.2.1\. [Pacman](#521-pacman)  
5.2.2\. [Mirrors](#522-mirrors)  
5.2.3\. [Arch Build System](#523-arch-build-system)  
5.2.3.1\. [Arch User Repository](#5231-arch-user-repository)  
5.3\. [Graphical User Interface](#53-graphical-user-interface)  
5.3.1\. [Display Servers](#531-display-servers)  
5.3.2\. [Desktop Environments](#532-desktop-environments)  
5.3.2.1\. [Window Managers](#5321-window-managers)  
5.3.3\. [Display Managers](#533-display-managers)  
5.4\. [Multimedia](#54-multimedia)  
5.5\. [Console Improvements](#55-console-improvements)  
...
This section highlights the prerequisites for installation of a new Arch Linux
system.

Arch Linux should run on any x86_64-compatible machine with a minimum of 512MB
RAM, though more memory is needed to boot the live system of installation. A
basic installation should take less than 2GB of disk space. It is also assumed
...
<ins>Example layout for Lenovo Thinkpad G500</ins>
...
<ins>Example mounts for Lenovo Thinkpad G500</ins>
...
- Install GRUB EFI application to '*mount-point*/EFI/GRUB'
	- `grub-install --target=x86_64-efi --efi-directory=mount-point --bootloader-id=GRUB`
...
Arch Linux system to improve and add common functionalities.
...
and saved in order of speed. This can be done manually using `rankmirrors`.
Rankmirrors only ranks the mirrors that are not commented out within the source
mirrorlist.

- Rank the top # fastest mirrors
    - `rankmirrors -n # mirrorlist.uncommented > /etc/pacman.d/mirrorlist`

This process can be automated by using a dedicated program, like "reflector".
...
source code. While pacman is the specialized Arch Linux tool for binary package
